...
public class MovieDTO {
	...
	private String nevercode;	// 네이버 영화코드
	...
	public MovieDTO(int rank, String movie, String imgsrc, String type, String opendate, String bookingrate,
			String runtime, String director, String actor, String nevercode, double naverscore, String daumcode,
			double daumscore) {
		super();
		this.rank = rank;
		this.movie = movie;
